...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center m-20 px-4 text-center
    text-gray-800'>
    ...
    <p className='mb-8 max-w-md'>Let's start with a quick product tour adn we will have you up and running in on time!</p>
